...
import { UserEquipments } from './user-equipments';

function UserRead(): JSX.Element {
  ...
  }, [departmentsStatus, dispatch, languagesStatus, positionsStatus, profilesStatus, rolesStatus, user, usersStatus]);
